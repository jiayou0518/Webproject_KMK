                    ...
                    <div class="login-content">
                        ...
                        <form action="./info.do" method="post">
                        	<div class="form-group">
                                <input type="text" class="form-control" name="uname" placeholder="이름" value="${ sessionScope.UserName }">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="email" value="${ sessionScope.UserEmail }" placeholder="Email" >
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="pnumber" placeholder="핸드폰 번호" value="${ sessionScope.UserPhone }">
                            </div>
                            <button type="submit" class="btn vizew-btn w-100 mt-30">정보 저장</button>
                        </form>
                    </div>
                </div>
            </div>
