                    ...
                    <div class="contact-form-area mt-50">
                        <form action="#" method="post" onsubmit="return validateForm(this);">
                        	<div class="form-group">
                        		<%-- <p>${ dto.idx }</p> --%>
                        		<p>작성자 : ${ dto.name } (${ dto.id })</p>
                                <%-- <input type="text" class="form-control" name="idx" value="${ dto.idx }"> --%>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control" cols="30" rows="20">${ dto.content }</textarea>
                            </div>
