                ...
                <div class="col-12 col-md-6">
                    <div class="login-content">
                        ...
                        <form method="post">
                            ...
                            <button type="button" onclick="location.href='./info.do';" class="btn vizew-btn w-100 mt-30" >정보 수정</button>

                            <button type="button" onclick="location.href='./logout.do';" class="btn vizew-btn w-100 mt-30" >로그아웃</button>
                        </form>
                    </div>
                </div>
            </div>
